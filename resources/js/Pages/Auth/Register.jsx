            ...
            <div className="mb-8">
                {isAr ? (
                    <h1 className="font-black mb-2"
                        ...
                        {t.heading1} <span style={{ color: '#1a1d20' }}>{t.heading2}</span>
                    </h1>
                ) : (
            ...
            <form onSubmit={submit} className="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        style={{ ...inputBase, border: errors.name ? '1.5px solid #ef4444' : '1.5px solid #e0e0e0' }}
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            dir="ltr"
                            className={`block w-full rounded-xl px-4 py-3.5 text-sm transition-all ${isAr ? 'pl-12' : 'pr-12'}`}
                            style={{ ...inputBase, border: errors.password_confirmation ? '1.5px solid #ef4444' : '1.5px solid #e0e0e0' }}
                            onFocus={e => e.target.style.borderColor = '#222831'}
                            onBlur={e => e.target.style.borderColor = errors.password_confirmation ? '#ef4444' : '#e0e0e0'}
                        />
                        <button type="button" tabIndex={-1}
