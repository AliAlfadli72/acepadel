        ...
        <GuestLayout lang={lang} setLang={setLang}>
            ...
            {status && (
                <div className="mb-6 text-sm font-medium px-4 py-3 rounded-xl border"
                    style={{ color: '#2C5234', backgroundColor: '#EEF4EE', borderColor: '#D9E8D9', fontFamily: isAr ? "'Cairo', sans-serif" : 'Inter, sans-serif' }}>
                    {status}
                </div>
            )}
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <div className="flex items-center justify-between pt-1">
                    <label className="flex items-center gap-2.5 cursor-pointer">
                        ...
                        <span className="text-sm" style={{ color: '#637060', fontFamily: isAr ? "'Cairo', sans-serif" : 'Inter, sans-serif' }}>
                            {t.remember}
                        </span>
                    </label>
                    {canResetPassword && (
            ...
            <div className="flex justify-center items-center gap-2 mb-6 text-sm" style={{ fontFamily: isAr ? "'Cairo', sans-serif" : 'Inter, sans-serif' }}>
                <span style={{ color: '#637060' }}>{t.noAccount}</span>
                <Link href={route('register')} className="font-bold hover:underline" style={{ color: '#2C5234', textUnderlineOffset: '3px' }}>
                    {t.register}
                </Link>
            </div>
